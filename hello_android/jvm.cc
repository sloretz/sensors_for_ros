 ...
 */
bool android_ros::HasPermission(struct ANativeActivity * activity, const char* perm_name) {
 ...
 * \note Requires Android API level 23 (Marshmallow, May 2015)
 */
void android_ros::RequestPermission(ANativeActivity* activity, const char * permission) {
    ...
    lJNIEnv->CallVoidMethod(
       activity->clazz, MethodrequestPermissions, perm_array, 0
    );
